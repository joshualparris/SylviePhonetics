## Suggested feature additions for the app

Each of these is a concrete feature idea with implementation subtasks. If the app does not already include them, these are strong candidates.
...
- [ ] Add alternative “sand / cream / paint” styles using a visual overlay and tactile-looking animation.
...
- [ ] Make the answer selection visual and active — e.g. big tiles or buttons arranged like stepping stones.
...
- Persist the new game mode settings in local storage if desired.
- Where possible, add these features as optional modes so the app stays gentle for 4-year-olds.